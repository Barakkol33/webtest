...
- Deleted the copyright comments from all files, we only need to keep them inside our ItemList.js and index.html
...
- Droped `src/components/ItemList.js`, and changed all the imports to separate ones
